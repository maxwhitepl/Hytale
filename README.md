# EN
Polish language pack for Hytale. The goal is to offer a more natural experience in everyday gameplay, translating interface texts and common messages to make playing and configuring everything more comfortable in Poland for game [Hytale.](https://hytale.com/)

> This translation is a work in progress: you may find untranslated lines or expressions that could be improved. It will be refined and expanded in future updates.

If you want to submit your fixes, please create a [pull request](https://github.com/maxwhitepl/Hytale/pulls) and send it to us, and we will check it, and if everything is okay, we will merge it with the project and mark the author of the corrections.
